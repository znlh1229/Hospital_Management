  <div class="page-section">
      <div class="container">
          ...
          <form class="main-form" method="POST" action="{{ url('appointment') }}">
              ...
              <div class="row mt-5 ">
                  ...
                  <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
                      <select name="doctor" id="departement" class="custom-select">
                          ...
                          @foreach ($showDoctor as $showDoctor)
                              <option value="{{ $showDoctor->name }}">{{ $showDoctor->name }} ----
                                  {{ $showDoctor->speciality }}</option>
                          @endforeach
                      </select>
                  </div>
              ...
              <button type="submit" class=" form-control zoomIn text-white wow" style="background:#00D9A5">Submit
                  Request</button>
          </form>
      </div>
  </div> <!-- .page-section -->
